...
```bash
stripe billing_portal configurations create -d "business_profile[privacy_policy_url]=https://sljrgtxkakzntfppkzix.supabase.co" -d "business_profile[terms_of_service_url]=https://sljrgtxkakzntfppkzix.supabase.co" -d "default_return_url=http://localhost:3000/profile" -d "features[subscription_cancel][enabled]=true" -d "features[payment_method_update][enabled]=true"
```

4. Set up webhook in Stripe Dashboard:
   - Endpoint: `https://sljrgtxkakzntfppkzix.supabase.co/functions/v1/stripe-webhook`
